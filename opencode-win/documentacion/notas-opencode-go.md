...
> ✏️ **Nota:** si un modelo de OpenCode Go deja de funcionar de repente, esto es lo que ocurre y cómo arreglarlo.
...
> `opencode-go/deepseek-v4.1-flash` (configurado en `opencode.jsonc`).
