...
**Ground file saved to:** ~/.config/opencode/common-ground/{project_id}/COMMON-GROUND.md
...
1. **Load ground file** from `~/.config/opencode/common-ground/{project_id}/COMMON-GROUND.md`
...
**Graph embedded in:** ~/.config/opencode/common-ground/{project_id}/COMMON-GROUND.md
