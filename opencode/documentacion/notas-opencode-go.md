# ☁️ Modelos de OpenCode Go alojados en China
Qué hacer si un modelo de OpenCode Go deja de funcionar de repente por el opt-in de alojamiento en China.

| ⚙️ Estado | 📅 Fecha | 👤 Usuario |
|-----------|----------|------------|
| 📝 Nota | 31/07/2026 · rev. 22/09/2026 | Antonio |
...
2. [Causa](#causa)
3. [Solución](#solución)
4. [Alternativa sin opt-in](#alternativa-sin-opt-in)
...
> 📁 `~/.config/opencode/documentacion/notas-opencode-go.md` · `~/Config/opencode/documentacion/notas-opencode-go.md`
