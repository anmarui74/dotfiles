...
| ⚙️ Estado | 📅 Fecha | 👤 Autor | 🖥️ Plataforma |
|-----------|----------|----------|----------------|
| ✅ Operativo | 18/08/2026 | Antonio | Arch Linux (CachyOS) |

> Herramienta CLI en **Rust** que respalda automáticamente los directorios personales
