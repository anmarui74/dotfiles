...
> [!NOTE]
> **Clobbering default keybinds.** This plugin uses `ctrl+shift+r` for voice
...
> avoid clobbering the factory default by using `ctrl+shift+r`. See
...
| ------------- | -------------- | -------------------------------------- |
| `/stt-record` | `ctrl+shift+r` | Start/stop recording + transcribe      |
